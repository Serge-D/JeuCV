...
// Fonction Constructeur pour génerer les fantomes
 var FabriqueDeFantome = function(){
    ...
    this.initialisationFantome = function(){
        ...
        imageFantome.src = .src;
        imageFantome.style.height = .hauteur; 
        imageFantome.style.width = .largeur;
        imageFantome.style.position = .position;
        imageFantome.style.left=.x+"px";
        imageFantome.style.top=.y+"px";
