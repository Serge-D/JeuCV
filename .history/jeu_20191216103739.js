...
// Fonction Constructeur pour génerer les fantomes
 var FabriqueDeFantome = function(fantomeId){
    ...
    this.collisionsPersonnage = function(){
        let perso1 = {
            x : parseInt(this.fantome.style.left),
            y : parseInt(this.fantome.style.top),
            width : 121,
            height : 90
        };
        let perso2 = {
            x : parseInt(this.containercontainer.style.left),
            y : parseInt(this.containercontainer.style.top),
            width : parseInt(this.containercontainer.style.width),
            height : parseInt(this.containercontainer.style.height)
        };
