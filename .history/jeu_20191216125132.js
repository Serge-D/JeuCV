 ...
 var FabriqueDeFantome = function(fantomeId){
    ...
    this.collisionsPersonnage = function(){
        let perso1 = {
            ...
            width : 73,
            height : 160
        };console.log(this.perso1.x);
        console.log(this.perso1.y);
...
var FabriqueDeBalle = function(){
    ...
    this.checkCollision = setInterval(this.collisions,20);
...
var score = 0;
var idmonscore = setInterval(function(){
    score += 10
    
    monscore.textContent = score;
    
},1000);
if(tableauFantome.length == 0)
